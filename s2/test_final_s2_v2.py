...
from extended_kalman_filter_s2 import extended_kalman_filter
import time
...
imu_data = zarr.open(
    r"C:/Users/Lenovo/Desktop/Master/ROB530/final project/s2/stim320_imu/stim320_imu",
    mode='r'
)
...
gt_data = zarr.open(
    r"C:/Users/Lenovo/Desktop/Master/ROB530/final project/s2/anymal_state_odometry/anymal_state_odometry",
    mode='r'
)
...
lidar_poses = np.load(
    r"C:/Users/Lenovo/Desktop/Master/ROB530/final project/s2/lidar/results/kiss_icp_input_poses.npy"
)

lidar_zarr = zarr.open(
    r"C:/Users/Lenovo/Desktop/Master/ROB530/final project/s2/lidar/hesai_points_undistorted/hesai_points_undistorted",
    mode='r'
)
...
plt.tight_layout()
plt.savefig('trajectory_comparison_s2.png', dpi=150)
plt.show()

# ---------------------------------------------------------------
# 6. Save trajectories
# ---------------------------------------------------------------
np.save('ekf_trajectory_s2.npy', trajectory)
print(f"\nEKF trajectory saved : ekf_trajectory_s2.npy  (shape={trajectory.shape})")

np.save('gt_trajectory_s2.npy', gt_pos)
print(f"GT trajectory saved  : gt_trajectory_s2.npy   (shape={gt_pos.shape})")