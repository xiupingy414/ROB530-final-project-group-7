...
# 
# =========================================================
project_dir = r"C:\Users\junxianw\Desktop\project2"

map_path = os.path.join(project_dir, "2024-11-03-07-52-45_dlio.ply")
...
radar_full_npz = os.path.join(
    radar_output_dir, "radar_icp_tf_full_output_project2_v1.npz"
)
radar_full_csv = os.path.join(
    radar_output_dir, "radar_icp_tf_full_output_project2_v1.csv"
)

ukf_full_npz = os.path.join(
    ukf_output_dir, "ukf_fusion_full_output_project2_v1.npz"
)
ukf_full_csv = os.path.join(
    ukf_output_dir, "ukf_fusion_full_output_project2_v1.csv"
)

radar_plot_traj_csv = os.path.join(
    radar_output_dir, "radar_full_trajectory_coords_project2_v1.csv"
)
ukf_plot_traj_csv = os.path.join(
    ukf_output_dir, "ukf_full_trajectory_coords_project2_v1.csv"
)

full_overlay_fig_path = os.path.join(
    project_dir, "full_radar_ukf_overlay_project2_v1.png"
)
...
if RUN_UKF_FUSION:
    ...
    ax.set_ylabel("y (m)")
    ax.set_zlabel("z (m)")
    ax.set_title("Full Pipeline: Radar + IMU UKF (project2)")
    ax.legend()
    ...
    # =========================================================
    # Runtime summary (saved before blocking plot window)
    # =========================================================
    algorithm_end_time = time.time()
    total_end_time = algorithm_end_time

    total_runtime_sec = total_end_time - total_start_time
    ...
    if processed_lidar_frames > 0:
        ...
        avg_runtime_per_frame_sec = float("nan")
