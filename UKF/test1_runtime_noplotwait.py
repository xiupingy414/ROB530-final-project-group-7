...
# 路径
# =========================================================
project_dir = r"C:\Users\junxianw\Desktop\project"

map_path = os.path.join(project_dir, "2024-10-01-11-29-55_dlio.ply")
...
# 
# =========================================================
radar_output_dir = os.path.join(project_dir, "output_radar")
ukf_output_dir = os.path.join(project_dir, "output_ukf")
...
# ---- Radar ICP + TF  ----
radar_full_npz = os.path.join(radar_output_dir, "radar_icp_tf_full_output_stim320_v2.npz")
radar_full_csv = os.path.join(radar_output_dir, "radar_icp_tf_full_output_stim320_v2.csv")

# ---- UKF  ----
ukf_full_npz = os.path.join(ukf_output_dir, "ukf_fusion_full_output_stim320_radar_v2.npz")
ukf_full_csv = os.path.join(ukf_output_dir, "ukf_fusion_full_output_stim320_radar_v2.csv")

# --------
radar_plot_traj_csv = os.path.join(radar_output_dir, "final_plot_radar_trajectory_coords.csv")
ukf_plot_traj_csv = os.path.join(ukf_output_dir, "final_plot_ukf_trajectory_coords.csv")
...
if RUN_UKF_FUSION:
    ...
    print("z range:", np.min(z), "to", np.max(z))
    ...
    print(f"Saved final radar plot trajectory CSV to: {radar_plot_traj_csv}")
    ...
    print(f"Saved final UKF plot trajectory CSV to: {ukf_plot_traj_csv}")
    ...
    ax.set_ylabel("y (m)")
    ax.set_zlabel("z (m)")
    ax.set_title("Full Pipeline: Radar + IMU UKF")
    ax.legend()
    ...
    plt.plot(radar_t, radar_pos[:, 0], label="Radar x")
    plt.plot(t, pos_corr[:, 0], label="UKF x")
    plt.xlabel("time (s)")
    plt.ylabel("x (m)")
    plt.title("x vs time")
    plt.grid(True)
    ...
    plt.figure(figsize=(8, 4))
    plt.plot(radar_t, radar_pos[:, 1], label="Radar y")
    plt.plot(t, pos_corr[:, 1], label="UKF y")
    plt.xlabel("time (s)")
    plt.ylabel("y (m)")
    plt.title("y vs time")
    plt.grid(True)
    ...
    plt.figure(figsize=(8, 4))
    plt.plot(radar_t, radar_pos[:, 2], label="Radar z")
    plt.plot(t, pos_corr[:, 2], label="UKF z")
    plt.xlabel("time (s)")
    plt.ylabel("z (m)")
    plt.title("z vs time")
    plt.grid(True)
